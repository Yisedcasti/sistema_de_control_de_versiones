...
<body>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h3 class="mb-3">Maestros sin curso y materia</h3>
                        ...
                        <?php foreach ($registros as $registro) : ?>
                            <tr>
                                <td class="text-center">
                                    <a class="text-reset" href="formularios.php?num_doc=<?php echo $registro->num_doc; ?>">
                                ...
                                <td class="text-center"><?php echo $registro->profesion; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
        ...
        <div class="col-md-12 text-center mt-5">
            <h3 class="mb-3">Maestros con cursos y materias </h3>
            <div class="table-responsive">
                <table class="table table-hover rounded shadow table-bordered table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($maestros as $maestro) : ?>
                            <tr>
                                <td class="text-center">
                                    <a class="text-reset" href="observador.php?num_doc=<?php echo $maestro['num_doc']; ?>">
                                        <?php echo $maestro['num_doc']; ?>
                                    </a>
                                </td>
                                <td class="text-center"><?php echo $maestro['nombres']; ?></td>
                                <td class="text-center"><?php echo $maestro['apellidos']; ?></td>
                                <td class="text-center"><?php echo $maestro['grado']; ?></td>
                                <td class="text-center"><?php echo $maestro['curso']; ?></td>
                                <td class="text-center"><?php echo $maestro['materia']; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                <?php if (empty($maestro)) echo "<p class='text-muted'>No se encontraron resultados.</p>"; ?>
            </div>
                    </div>
        </div>
    </main>
